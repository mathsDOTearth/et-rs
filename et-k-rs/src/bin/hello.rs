...
// Startup: init gp, run the kernel, return to firmware via ecall
// (SYSCALL_RETURN_FROM_KERNEL = 8, KERNEL_RETURN_SUCCESS = 0). The stack pointer
// is set by firmware before entry.
global_asm!(
